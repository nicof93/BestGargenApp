...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        PlantaDao.createTable(db, ifNotExists);
        PlagaDao.createTable(db, ifNotExists);
        AplicacionDao.createTable(db, ifNotExists);
        ProductoDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        PlantaDao.dropTable(db, ifExists);
        PlagaDao.dropTable(db, ifExists);
        AplicacionDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(PlantaDao.class);
        registerDaoClass(PlagaDao.class);
        registerDaoClass(AplicacionDao.class);
